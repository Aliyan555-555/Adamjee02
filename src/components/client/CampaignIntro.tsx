...
const CampaignIntro = () => {
  return (
    ...
    >
      ...
      <div className="text-7xl font-semibold md:w-[70%] text-white mt-10 flex flex-col items-center  ">
        ...
        <p> kahani, unki Zubani</p>
      </div>

      <div className="w-[80%] text-center text-lg mt-10 text-white p-8 rounded-2xl  backdrop-blur-lg bg-[#3285d73a]">
